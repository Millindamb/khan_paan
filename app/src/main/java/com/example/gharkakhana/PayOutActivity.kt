...
class PayOutActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityPayOutBinding  // ← fixed: was FragmentProfileBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ── Back button ────────────────────────────────────────────────────
        binding.goBackFromOrder.setOnClickListener { finish() }  // ← fixed: was inside PlaceMyOrder
    ...
    private fun setUserData() {
        ...
        // ── Show Firebase name immediately ─────────────────────────────────
